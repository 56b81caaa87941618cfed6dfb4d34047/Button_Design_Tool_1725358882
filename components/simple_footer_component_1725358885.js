...
<template>
    <footer id="footer-section" style="min-height: 670px" class="flex-1 bg-white dark:bg-gray-800">
        <div id="footer-container" class="max-w-screen-xl p-4 py-6 mx-auto lg:py-16 md:p-8 lg:p-10">
            ...
            <div class="flex">
                <div id="footer-text" class="flex-1 block text-sm text-center text-gray-500 dark:text-gray-400">
                    © 2023 ButtonCraft. Crafting perfect buttons for your digital needs.
                </div>
            </div>
        </div>
    </footer>
